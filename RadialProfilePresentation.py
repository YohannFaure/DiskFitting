...
if __name__=='__main__':
    ...
    plt.errorbar(r,m,yerr=s,barsabove=True,linestyle='',markeredgewidth=2,elinewidth=0.5,c='w')
    plt.scatter(r,m,s=0.8,c='w')
    plt.grid(True)
    ...
    #plt.yscale('log')
    plt.tight_layout()
    plt.savefig('radialprofile{}.pgf'.format(args.name if (args.name) else int(time())))
